----------------------------------------------------------------
README_(MushroomEPS).txt
----------------------------------------------------------------

King Tuber Oyster mushrooms were grown under various conditions. The original data for this study contained multiple incorrect entries and outliers. The cleaned data can be found in the file  MushDataEPS.xlsx. 

The training and deployment of the MushroomBio scripts are done with the purpose of find conditions which produce maximum amounts of a sugar, Exopolysaccharide EPS. The conditions which were varied were:
